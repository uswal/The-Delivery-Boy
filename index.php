        ...
        <div class="row-flex">
          <div style="width: 50%">
            ...
            >
              ...
              <p style="margin-top: 30px">
                <img src = "weak_reference_demo.svg" style="height:75vh">
               <!-- <p> This is as confusing as it gets </p>-->
              </p>
            </div>
          </div>
          <div style="width: 50%">
    ...
    <div class="slide" style="background-color: #fffcdc">
      <div class="content">
        <h1 class="make-me-blue">
          What do you understand from the above image ? I guess it would be safe to assume that 
          it did not enhance your understanding of how pointers work. If that's the case give pointers another
          shot by playing our game (you might as well end up liking it).
